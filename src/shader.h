...
public:
    ...
    // This method activates the shader program for subsequent draw calls.
    void use()
    {
        glUseProgram(ID);
    }
    ...
    {
        // This method compiles and links a vertex+fragment shader program.
        // vertex shader
    ...
    {
        // This method compiles and links a vertex+fragment+geometry shader program.
        // vertex shader
        unsigned int vertexShader = glCreateShader(GL_VERTEX_SHADER);
        glShaderSource(vertexShader, 1, &vertexShaderSource, NULL);
        glCompileShader(vertexShader);
